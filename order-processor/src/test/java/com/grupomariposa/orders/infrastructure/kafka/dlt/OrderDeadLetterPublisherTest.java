...
class OrderDeadLetterPublisherTest {
    ...
    @Test
    void should_keep_original_key_and_drop_delivery_attempt_header() {
        ...
        final ProducerRecord<Object, Object> produced = publisher.createProducerRecord(
                consumerRecord,
        ...
        assertThat(produced.timestamp()).isNull();
    ...
    @Test
    void should_prefer_raw_key_and_value_bytes_when_given() {
        final ProducerRecord<Object, Object> produced = publisher.createProducerRecord(
                consumerRecord,
                new TopicPartition("orders.processing.dlt", 1), new RecordHeaders(),
                new byte[] {4}, new byte[] {5});

        assertThat(produced.key()).isEqualTo(new byte[] {4});
