...
void main() {
  Money parse(String amount) => Money.parse(amount, currency: 'MXN');

  group('Money.parse', () {
    test('should convert decimal text into integer minor units', () {
      expect(parse('2100.11'), const Money(minorUnits: 210011, currency: 'MXN'));
    ...
    test('should reject text that is not a two decimal amount', () {
  ...
  test('should expose the amount for display and compare by value', () {
    ...
    expect(parse('1'), isNot(Money.parse('1', currency: 'COP')));
  });
}
